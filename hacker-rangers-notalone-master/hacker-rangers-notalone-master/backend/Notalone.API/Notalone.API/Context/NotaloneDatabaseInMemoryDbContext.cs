...
{
    public class NotaloneDatabaseInMemoryDbContext: DbContext, IDatabaseContext
    {
        private IDbContextTransaction _currentTransaction;

        public NotaloneDatabaseInMemoryDbContext(DbContextOptions<NotaloneDatabaseInMemoryDbContext> options)
            : base(options)
        {
        }
